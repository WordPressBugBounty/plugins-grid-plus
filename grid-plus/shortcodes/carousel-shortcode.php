...
$authors = isset($grid_data_source['authors']) ? $grid_data_source['authors'] : array();
$post_type = isset($grid_data_source['post_type']) ? $grid_data_source['post_type'] : 'post';
$categories = isset($grid_data_source['categories']) && $grid_data_source['categories'] != '' ? $grid_data_source['categories'] : array();
$show_category = isset($grid_data_source['show_category']) ? $grid_data_source['show_category'] : 'none';
$cate_multi_line = isset($grid_data_source['cate_multi_line']) ? $grid_data_source['cate_multi_line'] : 'false';
$include_ids = isset($grid_data_source['include_ids']) ? $grid_data_source['include_ids'] : array();
$exclude_ids = isset($grid_data_source['exclude_ids']) ? $grid_data_source['exclude_ids'] : array();
$order = isset($grid_data_source['order']) ? $grid_data_source['order'] : 'ASC';
$order_by = isset($grid_data_source['order_by']) ? $grid_data_source['order_by'] : 'date';
